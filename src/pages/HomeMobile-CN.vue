<template>
  <div>
    ...
    <div class="mobile-cta">
      <a class="full-width" :href="i18n('bedding-sets', 'catUrl')" id="HP_hero_bed-mob">
        <picture>
          <source srcset="./../assets/images/misc/fill.gif" media="(min-width: 769px)">
          <img src="./../assets/images/banners/mo-bed-mob.jpg" :alt="i18n('$local.$category.bed')" @load="topImageLoaded">
        </picture>
        <span>{{i18n('$local.$category.bed')}} ></span>
      </a>
      <div class="mob-bedding clear">
        <a :href="i18n('bed-bedding', 'catUrl')" id="HP-title-bedding">
          <h2 class="mob-title">{{i18n('$local.$category.bedding')}}</h2>
        </a>
          <ul>
            <li>
              <a :href="i18n('bedding-sets', 'catUrl')" id="HP_bedding_sets_mob"><span>{{i18n('$local.$product.beddingSets')}} ></span>
                  <p>
                      <picture>
                          <source srcset="./../assets/images/misc/fill.gif" media="(min-width: 769px)">
      ...
      <div class="mob-bath-spa clear">
        <a :href="i18n('fragrance', 'catUrl')" id="HP-title-bath-spa">
          <h2 class="mob-title">{{i18n('$local.$hpCopy.fragranceHeading')}}</h2>
        </a>
        <a class="mob-single" :href="i18n('fragrance', 'catUrl')" id="HP_bath_body_mob">

          <picture>
            <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
            <img src="./../assets/images/cinemagraphs/HP-Fragrance.jpg" :alt="i18n('$local.$hpCopy.fragranceHeading')">
          </picture>
        </a>
        <ul>
          <li>
          <a :href="i18n('signature-towels', 'catUrl')" id="CTA-Towels-mob"><span>{{i18n('$local.$category.towels')}} ></span>
            <p>
                <picture>
                    <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
        ...
        <li>
        <a :href="i18n('robes', 'catUrl')" id="CTA-lotion-mob"><span>{{i18n('$local.$category.robes')}} ></span>
          <p>
            <picture>
                <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
                <img class="lazy" src="./../assets/images/banners/HP-Robes-mob.jpg" :alt="i18n('$local.$category.robes')">
            </picture>
        </p>
        </a>
        </li>
      ...
      <div class="mob-little-fans clear">
        <a :href="i18n('little-fans', 'catUrl')" id="HP-title-bath-spa">
          <h2 class="mob-title">{{i18n('$local.$category.littleFans')}}</h2>
        </a>
        <ul>
        <li>
        <a :href="i18n('little-fans', 'catUrl')" id="CTA-little-fans-bedding-mob"><span>{{i18n('$local.$category.miniMoLinens')}} ></span>
        <p>
            <picture>
                <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
        ...
        <li>
        <a :href="i18n('little-fans_minimo-bathrobe', 'prodUrl')" id="CTA-little-fans-robe-mob"><span>{{i18n('$local.$product.minimoRobe')}} ></span>
          <p>
            <picture>
                <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
    ...
    <div class="mob-gifts clear clearfix">
         <a :href="i18n('m-o-signature-gifts', 'catUrl')" id="HP-title-gifts">
          <h2 class="mob-title">{{i18n('$local.$category.signatureGifts')}}</h2>
        </a>
        <a class="mob-single" :href="i18n('m-o-signature-gifts', 'catUrl')" id="CTA-Shorts-mob">
        <p>
            <picture>
                <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
                <img class="lazy" src="./../assets/images/banners/hp-exclusives2.jpg" :alt="i18n('$local.$hpCopy.signatureHeading')">
            </picture>
        </p>
        </a>
        <!-- <ul>
        ...
        <li> -->
        <!-- <a class="mob-single" :href="i18n('slippers_aquazzura-slippers', 'prodUrl')" id="CTA-gifts-mob">
          <span>{{i18n('$local.$category.slippers')}}</span>
          <p>
          <picture>
            <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
    ...
    <div class="mob-exclusives clear clearfix">
        <a :href="i18n('hotel-exclusives', 'catUrl')" id="HP-title-exclusives">
          <h2 class="mob-title">{{i18n('$local.$category.hotelExclusives')}}</h2>
        </a>
        <ul>
          <li>
            <a :href="i18n('hotel-exclusives_fan-by-vivienne-tam', 'prodUrl')" id="CTA-Kimono-mob"><span>{{i18n('$local.$product.fanByVivienne')}} ></span>
              <p>
                <picture>
                    <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
          ...
          <li>
            <a :href="i18n('hotel-exclusives_scarf-by-jim-thompson', 'prodUrl')" id="CTA-Kimono-mob"><span>{{i18n('$local.$product.scarfByJim')}} ></span>
              <p>
                <picture>
                    <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
          ...
          <li>
          <a :href="i18n('hotel-exclusives_japanese-yukata', 'prodUrl')" id="CTA-Kimono-mob"><span>{{i18n('$local.$product.japaneseYukata')}} ></span>
            <p>
              <picture>
                  <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
          ...
          <li>
          <a :href="i18n('moroccan-tassel-towels', 'catUrl')" id="CTA-turkish-towels-mob"><span>{{i18n('$local.$category.tasselTowels')}} ></span>
          <p>
              <picture>
                  <source srcset="images/misc/fill.gif" media="(min-width: 769px)">
...
export default {
  ...
  methods: {
    ...
    i18n (value, type) {
      if (type === 'prodUrl') {
        return this.lang + '/p/' + value
      } else if (type === 'catUrl') {
        return this.lang + '/c/' + value
      } else if (type === 'hpCopy') {
